...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        args = (
            ...
            raster_settings.pixel_cx,
            raster_settings.pixel_cy,
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, radii, out_observe, out_all_map, out_peak_index, out_peak_weight, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
            except Exception as ex:
                torch.save(cpu_args, "snapshot_fw.dump")
                print("\nAn error occured in forward. Please forward snapshot_fw.dump for debugging.")
                raise ex
        else:
            num_rendered, color, radii, out_observe, out_all_map, out_plane_depth, out_peak_index, out_peak_weight, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
        ...
        return color, radii, out_observe, out_all_map, out_plane_depth, out_peak_index,  out_peak_weight

    @staticmethod
    def backward(ctx, grad_out_color, grad_radii, grad_out_observe, grad_out_all_map, grad_out_plane_depth, grad_out_peak_index, grad_out_peak_weight):
