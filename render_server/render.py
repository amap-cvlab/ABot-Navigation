...
class GSRender:
    ...
    def render_set(self, cam_extrinsics, cam_intrinsics):
...
if __name__ == "__main__":
    ...
    gsrender.render_set(
        ["137 0.6929961794728361 0.6868527312121395 -0.15314485435568045 0.15664059003608935 -1.5592032322679723 -2.128928183474061 -0.29175430476615516 1 image_137.jpg"],
